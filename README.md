...
16:22监督更新：Token保存/恢复验收通过，16:06自动启动正式100步，已完成Step2。
前两步梯度27.061/21.436有限，截断16/32、14/32；64条正式输入与Block3对应批次对齐。
正式轨迹、Step1诊断和恢复证据已本地备份；仍有重复尾部，未修改配置或重启。
这只是早期监督结果，Token正式权重及完整评测仍待完成，详见上方监督记录。
