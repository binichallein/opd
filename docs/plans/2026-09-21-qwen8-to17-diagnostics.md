...
- [x] Base组结果：独立解题师生均13/128，续写13/64至16/64，能力证据不足。
- [x] 指令组GPU非thinking验收和能力结果：两模型检查通过；独立38/128至60/128，续写18/64至32/64，能力门槛通过。

启动证据见[启动记录](../results/2026-09-21-qwen8-to17-diagnostics-startup.md)。
21:40队列全部完成，未启动训练；[最终结果](../results/2026-09-21-qwen8-to17-final.md)。
完成验收任务不等于Base教师通过，也不等于OPD训练有效。
