...
The historical endpoint comparison is reported in Table~\ref{tab:historyendpoints}; the following figures and tables retain the complete checkpoint trajectories.
\begin{figure}[p]
\centering
