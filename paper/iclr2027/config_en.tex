...
The public teacher's retained model card identifies \texttt{lllyx/Qwen3-4B-Base-GRPO}, associated with Rethinking OPD \citep{rethinking}. It is a researcher's GRPO-adapted checkpoint, not an official Qwen instruction model and not a privately trained checkpoint from this project.
