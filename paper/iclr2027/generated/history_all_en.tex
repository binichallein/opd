\subsection{H01: Early weighting pilots}
\label{history:early_weights50}
Training seeds: 7, 13; recorded training steps: 50.
...
\subsection{H02: Outcome weighting and long-run pilots}
\label{history:early_outcome200}
Training seeds: 7; recorded training steps: 200.
\paragraph{Full n=1: original simple grader, accuracy}
{\footnotesize\setlength{\tabcolsep}{3.5pt}
\begin{longtable}{@{}p{1.4in}rrrr@{}}
\toprule
...
\subsection{H03: Reference-anchor pilots}
\label{history:early_anchor100}
Training seeds: unrecorded; recorded training steps: 100.
\paragraph{Full n=1: original simple grader, accuracy}
{\footnotesize\setlength{\tabcolsep}{3.5pt}
\begin{longtable}{@{}p{1.4in}rrrr@{}}
\toprule
...
\subsection{H04: Naive block-sum pilot}
\label{history:early_blocksum50}
Training seeds: 7; recorded training steps: 50.
...
\subsection{H05: Block sum, mean and mixed pilot}
...
\subsection{H06: Qwen 1.7B block-size sweep}
\label{history:qwen17_sweep}
Training seeds: 21; recorded training steps: 200.
...
\subsection{H07: Block10 two-host diagnostic repetitions}
\label{history:block10_collapse}
Training seeds: 21; recorded training steps: 200.
\emph{Historical built-in AMC23 grading has a compatibility caveat; zeros are not independently validated capability measurements.}
...
\subsection{H08: Qwen 1.7B same-host paired study}
...
\subsection{H09: Qwen 1.7B checkpoint re-evaluation}
\label{history:qwen17_reeval}
Training seeds: 21; recorded training steps: --.
...
\subsection{H10: DeepSeek/JustRL paired study}
...
\subsection{H11: Random3 and Sliding3 paired study}
...
\subsection{H12: Qwen 0.6B old-prompt interrupted attempt}
...
\subsection{H13: Qwen 0.6B non-thinking paired study}
...
\subsection{H14: Llama 3.2 original-prompt interrupted attempt}
\label{history:llama_native_stopped}
Training seeds: 21; recorded training steps: 146.
\paragraph{Historical external grader: Avg@8 / Pass@8}
{\footnotesize\setlength{\tabcolsep}{3.5pt}
\begin{longtable}{@{}p{1.4in}rrrrrr@{}}
\toprule
...
\subsection{H15: Llama 3.2 historical-prompt paired study}
...
\subsection{H16: Qwen 4B ChatML interrupted attempt}
\label{history:qwen4_chatml_stopped}
Training seeds: 21; recorded training steps: 4.
No completed benchmark result is recorded for this attempt.
\subsection{H17: Qwen 4B completion study}
\label{history:qwen4_completion}
Training seeds: 21; recorded training steps: 200.
See Appendix~\ref{app:current} for the final current-pair results.
