...
\centering
\small
\caption{Qwen3-4B completion, seed21, COMPLETE. All scores in percent; NA = unavailable.}
\begin{tabular}{lllrrrr}
\toprule
Benchmark & Method & Step & Avg@8 & Pass@8 & No box & Trunc. \\
\midrule
...
\bottomrule
\end{tabular}
\par\smallskip\footnotesize No box: no literal \texttt{\textbackslash boxed}; truncation: engine length stop.
\end{table*}
