#!/usr/bin/env bash
set -euo pipefail
RUN_DIR='/limx_embap/tos/user/Yaleon/opd_block_experiments_20260709/opd/runs/20260925v1_historical17_components_n1_batch32_seed21_ml2/joint3'
...
export TMPDIR='/dev/shm/ha/joint3/train/tmp'
export VLLM_CACHE_ROOT='/dev/shm/ha/joint3/train/vllm_cache'
export TORCHINDUCTOR_CACHE_DIR='/dev/shm/ha/joint3/train/torchinductor'
export TRITON_CACHE_DIR='/dev/shm/ha/joint3/train/triton'
export CUDA_CACHE_PATH='/dev/shm/ha/joint3/train/cuda_cache'
export OUTLINES_CACHE_DIR='/dev/shm/ha/joint3/train/outlines'
