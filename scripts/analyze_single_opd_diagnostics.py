...
METRIC_FAMILIES = (
    ...
    ("Signed entropy gap", "Student entropy - Teacher entropy，保留方向。"),
    ...
    ("Overlap-token advantage", "共享 token 上 teacher_logp - old_student_logp 的均值。"),
    ("SignFlipRate / WeightedSignFlipRate", "聚合前后 advantage 符号翻转比例及按绝对幅度加权的翻转比例。"),
    ("LeakageMagnitude / NormalizedLeakage", "Block 共享信号施加到原本反向 token 上的泄漏量及其归一化值。"),
