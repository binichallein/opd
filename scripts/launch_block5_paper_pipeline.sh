...
RUN_ROOT="${RUN_ROOT:-${REMOTE_ROOT}/runs/20260709_block5_dapo17k_paper_qwen3}"
...
nohup bash '${REMOTE_ROOT}/scripts/run_block5_paper_pipeline_on_train.sh' > '${RUN_ROOT}/pipeline_logs/pipeline.nohup.log' 2>&1 &
