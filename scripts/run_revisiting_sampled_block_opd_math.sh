...
protocol_args=()
if [[ "${OPD_PROMPT_PROTOCOL:-legacy}" == math_eval_nonthinking_v1 || "${OPD_PROMPT_PROTOCOL:-legacy}" == llama32_nonthinking_v1 ]]; then
    ...
    if [[ "${OPD_PROMPT_PROTOCOL}" == llama32_nonthinking_v1 ]]; then
